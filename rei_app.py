...
Original file is located at
    https://colab.research.google.com/drive/18OtSnq9ZdeJz5BkFtt8P22UUxjdkV0ZP
"""
#reference: https://github.com/imfing/keras-flask-deploy-webapp
...
def predict():
    if request.method == 'POST':
        ...
        return jsonify(result= preds.capitalize()+" Confidence: {}%".format(confi))
